...
function pgList(state = {resultList: [], total: 0, pageNo: 1}, action) {
    switch (action.type) {
        case EditorProductForActivityAction.SEARCH_PRODUCTFORACTIVITY_LIST:
            return action.data;
        default :
            return state;
    }
...
function editRecord(state = {}, action) {
    switch (action.type) {
        case EditorProductForActivityAction.PRODUCTFORACTIVITY_INIT_EDIT_RECORD:
            return {};
        case EditorProductForActivityAction.PRODUCTFORACTIVITY_SET_EDIT_RECORD:
...
function editRecordList(state = [] ,action){
    switch (action.type) {
        ...
        case EditorProductForActivityAction.PRODUCTFORACTIVITY_SET_EDITING_RECORD:
...
function areaPriceDetailList(state = [], action) {
    switch (action.type) {
        case EditorProductForActivityAction.PRODUCTFORACTIVITY_AREA_PRICE_DETAIL:
            return action.data;
        default:
            return state;
    }
